...
console.log("Name is " + tyler.name, "Email is " + tyler.email, "pw is " + tyler.pw)

console.log('Lenny\'s information is ');
//Now console.log all of Lennys information

console.log("Name is " + lenny.name, "Email is " + lenny.email, "pw is " + lenny.pw)


//Now create another instance of User using your own information and then add that to your users array.

var jeff = new User("Jeff", "jeffcchapman@gmail.com", "IamStarLord");
users.push(jeff);
